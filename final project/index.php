...
?>
        ...
        <div class="image">
            ...
            <div class="content">
                ...
                <form>
                    <a href="itinerary.php?package_id=<?php //echo $row['id']; ?>" class="btn" style="background-color:black; height:30px, width:30px; color:white; border-radius:0%;">More Details</a>
